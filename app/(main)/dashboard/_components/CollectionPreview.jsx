...
const CollectionPreview = ({
  ...
  return (
    <Link
      href={`/collections/${isUnorganized ? "unorganized" : id}`}
    ...
    >
      ...
      />
      <div
        className={`relative h-full rounded-lg p-6 shadow-md hover:shadow-lg transition-all flex flex-col items-center justify-center gap-4 ${
